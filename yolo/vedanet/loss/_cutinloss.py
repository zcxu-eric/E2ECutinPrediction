...
class CutinLoss(nn.modules.loss._Loss):
    """ Computes cutin loss from cutin prediction network output and target annotation.
    ...
    def __init__(self, num_classes, anchors, anchors_mask, reduction=32, seen=0, coord_scale=1.0, noobject_scale=1.0,
                 object_scale=5.0, class_scale=1.0, thresh=0.6, head_idx=0):
        super().__init__()
